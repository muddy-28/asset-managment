                        ...
                        <tr>
                            ...
                            <td>
                                <?php if (!empty($row['img'])): ?>
                                    <img src="<?php echo htmlspecialchars($row['img'], ENT_QUOTES, 'UTF-8'); ?>" alt="Service Image" style="width:48px;height:48px;object-fit:cover;border-radius:4px;">
                                <?php else: ?>
                            ...
                            <td>
                                ...
                                <a href="#" class="btn btn-sm btn-danger btn-delete" data-url="delete.php?id=<?php echo $row['id']; ?>" data-name="<?php echo htmlspecialchars($row['title'] ?? '', ENT_QUOTES, 'UTF-8'); ?>"><i class="fas fa-trash"></i></a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
