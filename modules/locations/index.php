...
$stmt = $pdo->prepare("SELECT l.*, f.floor_name, d.department_name FROM locations l LEFT JOIN floors f ON l.floor_id = f.id LEFT JOIN departments d ON l.department_id = d.id ORDER BY l.id DESC");
$stmt->execute();
