...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($title === '') {
        ...
        if (isset($_FILES['img']) && $_FILES['img']['error'] === UPLOAD_ERR_OK) {
            ...
            $fileName = 'service_' . $id . '_' . uniqid() . '.' . strtolower($ext);
        ...
        $stmt->execute([$title, $description, $imgPath, $id]);
            ...
            <div class="card-body">
                <form method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="title" name="title" value="<?php echo htmlspecialchars($service['title'] ?? '', ENT_QUOTES, 'UTF-8'); ?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="img" class="form-label">Image</label>
                        <?php if (!empty($service['img'])): ?>
                            <div class="mb-2">
                                <img src="<?php echo htmlspecialchars('../../' . $service['img'], ENT_QUOTES, 'UTF-8'); ?>" alt="Current Image" style="width:80px;height:80px;object-fit:cover;border-radius:4px;">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="description" name="description" rows="4" placeholder="Enter service description"><?php echo htmlspecialchars($service['description'] ?? '', ENT_QUOTES, 'UTF-8'); ?></textarea>
                    </div>
