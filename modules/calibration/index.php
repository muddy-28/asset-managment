...
$pageTitle = 'Asset Calibrations';

$stmt = $pdo->query("
    SELECT c.*, a.asset_name, v.vendor_name
...
<div class="main-content" id="mainContent">
    <div class="container-fluid py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="create.php" class="btn btn-primary"><i class="fas fa-plus"></i> Add Calibration</a>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                <table class="table table-striped datatable">
                    ...
                    <tbody>
                        <?php foreach ($calibrations as $i => $row): ?>
                            <tr>
                                <td><?php echo $i + 1; ?></td>
                                <td><?php echo htmlspecialchars($row['asset_name'] ?? '', ENT_QUOTES, 'UTF-8'); ?></td>
                                <td><?php echo htmlspecialchars($row['calibration_date'] ?? '', ENT_QUOTES, 'UTF-8'); ?></td>
                                <td><?php echo htmlspecialchars($row['calibration_due'] ?? '', ENT_QUOTES, 'UTF-8'); ?></td>
                                <td><?php echo htmlspecialchars($row['certificate_number'] ?? '', ENT_QUOTES, 'UTF-8'); ?></td>
