...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($location_name === '') {
        ...
        try {
            ...
            $_SESSION['error_message'] = 'Error creating location: ' . $e->getMessage();
        }
    }
}
...
<div class="main-content" id="mainContent">
    <div class="container-fluid py-4">
        <div class="row mb-4">
            <div class="col-12">
                <h2 class="mb-0"><i class="fas fa-plus me-2"></i>Add Location</h2>
            </div>
        </div>
            ...
            <div class="card-body">
                <form method="POST" action="">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="location_name" name="location_name" required value="<?php echo htmlspecialchars($_POST['location_name'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
                    </div>

                    <div class="mb-3">
                        <label for="room_number" class="form-label">Room Number</label>
                        <input type="text" class="form-control" id="room_number" name="room_number" value="<?php echo htmlspecialchars($_POST['room_number'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
                    </div>
