...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($department_name === '') {
        ...
        try {
            ...
            $_SESSION['error_message'] = 'Error creating department: ' . $e->getMessage();
        }
    }
}
...
<div class="main-content" id="mainContent">
    <div class="container-fluid py-4">
        <div class="row mb-4">
            <div class="col-12">
                <h2 class="mb-0"><i class="fas fa-plus me-2"></i>Add Department</h2>
            </div>
        </div>
            ...
            <div class="card-body">
                <form method="POST" action="">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="department_name" name="department_name" required value="<?php echo htmlspecialchars($_POST['department_name'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
                    </div>

                    <div class="mb-3">
                        <label for="department_code" class="form-label">Department Code</label>
                        <input type="text" class="form-control" id="department_code" name="department_code" value="<?php echo htmlspecialchars($_POST['department_code'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="floor_id" name="floor_id">
                            ...
                            <?php foreach ($floors as $floor): ?>
                                <option value="<?php echo $floor['id']; ?>" <?php echo (isset($_POST['floor_id']) && $_POST['floor_id'] == $floor['id']) ? 'selected' : ''; ?>>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="description" name="description" rows="3"><?php echo htmlspecialchars($_POST['description'] ?? '', ENT_QUOTES, 'UTF-8'); ?></textarea>
                    </div>
