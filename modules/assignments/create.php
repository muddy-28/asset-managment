...
$stmt = $pdo->prepare("SELECT id, asset_name, asset_tag FROM assets ORDER BY asset_name");
$stmt->execute();
...
$stmt = $pdo->prepare("SELECT id, location_name FROM locations ORDER BY location_name");
$stmt->execute();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$asset_id) {
        ...
        try {
            ...
            $_SESSION['error_message'] = 'Error creating assignment: ' . $e->getMessage();
        }
    }
}
...
<div class="main-content" id="mainContent">
    <div class="container-fluid py-4">
        <div class="row mb-4">
            <div class="col-12">
                <h2 class="mb-0"><i class="fas fa-plus me-2"></i>Add Assignment</h2>
            </div>
        </div>
            ...
            <div class="card-body">
                <form method="POST" action="">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="assigned_date" name="assigned_date" value="<?php echo htmlspecialchars($_POST['assigned_date'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="status" name="status">
                            ...
                            <option value="moved" <?php echo (($_POST['status'] ?? '') === 'moved') ? 'selected' : ''; ?>>Moved</option>
                        </select>
                    </div>
